...
export IMAGE_URL=${IMAGE_URL-quay.io/chetna14manku_org/backend-tests-java-springboot-vhbgmfeg:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/chetna14manku-org/backend-tests-java-springboot-vhbgmfeg-gitops
